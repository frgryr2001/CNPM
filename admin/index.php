...
<body>
    ...
    <div class="offcanvas offcanvas-start sidebar-nav bg-dark" tabindex="-1" id="sidebar">
        <div class="offcanvas-body p-0">
            <nav class="navbar-dark">
                <ul class="navbar-nav">
                    ...
                    <li class="<?php if (isset($_GET['page']) && $_GET['page'] == 'overview') {
                                    echo 'bg-secondary';
                                } ?>">
                        <a href="?page=overview" class="nav-link nav-link-custom px-3">
        ...
        <!-- Trang tổng quan -->
        <?php if (isset($_GET['page']) && $_GET['page'] == 'overview') { ?>
            <!-- offcanvas -->
    <main class="mt-5 pt-3">
        ...
        <!-- Trang Tài khoản -->
        <?php if (isset($_GET['page']) && $_GET['page'] == 'accounts') { ?>
            <div class="row">
                <div class="col-md-12 mb-3">
                    <div class="card">
                        <div class="card-header">
